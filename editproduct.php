...
session_start();
    if(!empty($_GET['id'])){
        ...
        if($result->num_rows > 0){  
            ...
            $product_name = $user_data['produto'];
            $product_price = $user_data['preco'];
            }
        }else{
...
<main class="form-signin w-100 m-auto">
  <form action="saveedit.php" method="POST">
    ...
    <div class="form-floating">
      <input type="text" name="nomeprod" class="form-control" id="floatingInput" value="<?php echo $product_name ?>" required>
      <label for="floatingInput">Nome do Produto</label>
    </div>
    <div class="form-floating">
      <input type="text" name="precoprod" class="form-control" id="floatingPreco" value="<?php echo $product_price ?>" required>
